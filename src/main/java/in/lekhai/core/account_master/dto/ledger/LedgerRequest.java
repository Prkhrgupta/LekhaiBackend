...
public record LedgerRequest(
        @JsonProperty("gst_in_number") String gstInNumber,
        @NotBlank String name,
        @JsonProperty("account_group") Long accountGroup,
        @JsonProperty("opening_balance") BigDecimal openingBalance,
        @JsonProperty("account_entry_type") AccountEntryType accountEntryType,
        @JsonProperty("legal_name") String legalName,
        @JsonProperty("Location") String location,
        @JsonProperty("country_name") String countryName,
        @JsonProperty("state_and_code") String stateAndCode,
        @JsonProperty("mail_to") MailTo mailTo,
        ...
        @JsonProperty("transport_id") Long transportId,
        @JsonProperty("tan_number") String tanNumber,
        @JsonProperty("broker_id") Long brokerId,

        boolean gstInDetailsPresent,
        @JsonProperty("gst_in_details") GstInDetail gstInDetails,
        @JsonProperty("aadhaar_number") String aadhaarNumber,
        @JsonProperty("image_uploaded") boolean imageUploaded,
        String email,
        @JsonProperty("msme_number") String msmeNumber,
        double distance, // calculate
        @JsonProperty("pin_code") String pinCode,
        String city) {
    public record MailTo(
            @JsonProperty("mail_to_line_1") String lineOne,
            @JsonProperty("mail_to_line_2") String lineTwo,
            @JsonProperty("mail_to_line_3") String lineThree) {
    }
